...
public class JanusGraphRemoteApp extends JanusGraphApp{

    private static final Logger LOGGER = LoggerFactory.getLogger(JanusGraphRemoteApp.class);
     ...
     */
    public JanusGraphRemoteApp(final String fileName) {
        super(fileName);
    ...
    public static void main(String[] args) {
        final String fileName = (args != null && args.length > 0) ? args[0] : "jgex-remote.properties";
        final JanusGraphRemoteApp app = new JanusGraphRemoteApp(fileName);
